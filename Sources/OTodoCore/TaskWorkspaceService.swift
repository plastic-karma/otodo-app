...
public actor TaskWorkspaceService {
    ...
    private func newProject(
        slug: String, name: String, body: String = "", in workspace: WorkspaceState
        ...
        let project = try TodoProject(
            ...
            name: name.trimmingCharacters(in: .whitespacesAndNewlines), body: body
        )
    ...
    public func addTasks(
        ...
        for rawName in names {
            ...
            let task = try TodoTask(
                ...
                projectSlugs: projectSlugs,
                tags: tags,
                dueDate: detected?.resolvedDueDate(selectedDate: defaultDueDate) ?? defaultDueDate,
